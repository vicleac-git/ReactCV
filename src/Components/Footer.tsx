...
function Footer({ profile }: FooterProps) {
  ...
  return (
    <footer className="bg-slate-950 text-white py-10 border-t border-violet-500/20">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-6">
          {/* LinkedIn */}
          <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-violet-400 transition duration-300 hover:scale-110 transform">
          ...
          {/* GitHub */}
          <a href={profile.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition duration-300 hover:scale-110 transform">
          ...
          {/* Email */}
          <a href={`mailto:${profile.email}`} className="text-gray-400 hover:text-violet-400 transition duration-300 hover:scale-110 transform">
